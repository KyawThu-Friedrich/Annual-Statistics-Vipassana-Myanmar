...
# Load data
df = pd.read_csv("AnnualReport2025.csv")

st.title("Vipassana Myanmar 2025: Annual Report Dashboard")
...
total_students = df['TotalStu'].fillna(0).astype(int).sum()
